...
const cardList = ["fa-diamond", "fa-paper-plane-o", "fa-anchor", "fa-bolt", "fa-cube", "fa-leaf", "fa-motorcycle", "fa-bomb"]; 
...
function endGame(){
    ...
    vex.dialog.confirm({
        message: `Congratulations! You won the game in ${timeCount} seconds with ${moves} moves and ${stars}/3 rating. Do you want to play again?`,
